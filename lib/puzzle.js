...
var Emitter = require('../emitter'); /* WTF? */
...
*/		if (iw<this.minImageSize || ih<this.minImageSize || iw>(cw-opts.bedMargin*2) || ih>(ch-opts.bedMargin*2)) {
		...
		console.log("Original image size (w × h): "+this.imageSource.width+"px × "+this.imageSource.height+"px");
...
Puzzle.prototype = Object.create(Emitter.prototype);
